...
function Edit({
  ...
  if (Array.isArray(glossarys)) {
    glossarys.forEach(glossary => {
      glossaryoptions.push({
        label: glossary.title.rendered || (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('No title', 'rrze-glossary'),
        value: glossary.id
      });
    });
  }
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.BlockControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.HeadingLevelDropdown, {
    options: [2, 3, 4, 5, 6],
    value: hstart,
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Filter options', 'rrze-glossary'),
    initialOpen: true
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select categories to filter glossary entries.', 'rrze-glossary'),
    value: categorystate,
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select tags to filter glossary entries.', 'rrze-glossary'),
    value: tagstate,
    options: tagoptions,
    onChange: onChangeTag,
    multiple: true
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.SelectControl, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Individual Glossary-Entries', 'rrze-glossary'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select glossary entries to filter glossary entries.', 'rrze-glossary'),
    value: idstate,
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Select language to filter glossary entries.', 'rrze-glossary'),
    options: [{
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Group by', 'rrze-glossary'),
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Groups Glossary-Entries by category or tags.', 'rrze-glossary'),
    options: [{
    ...
    help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Controls the Appearance of the Tab bar.', 'rrze-glossary'),
    options: [{
  ...
  }), !glossary || glossary === 'none' ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToggleControl, {
  ...
  }), !hide_accordion && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToggleControl, {
    ...
    options: ["fau", "med", "nat", "phil", "rw", "tf"].map(c => ({
      label: c,
      value: c
    })),
    onChange: value => setAttributes({
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Style', 'rrze-glossary'),
    options: ["light", "dark"].map(s => ({
      label: s,
      value: s
    })).concat([{
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('none', 'rrze-glossary'),
      value: ''
    }]),
    onChange: value => setAttributes({
      style: value
    })
  })), hide_accordion && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.ToggleControl, {
    checked: !!hide_title,
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Hide title', 'rrze-glossary'),
    onChange: () => setAttributes({
      hide_title: !hide_title
    })
  })) : null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.PanelBody, {
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Sorting options', 'rrze-glossary'),
    initialOpen: false
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.SelectControl, {
...
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"create-block/rrze-glossary","version":"2.1.1","title":"Glossary RRZE","category":"rrze","description":"Display glossaries","icon":"book","example":{},"attributes":{"category":{"type":"array","items":{"type":"number"},"default":[]},"tag":{"type":"string"},"id":{"type":"string"},"register":{"type":"string"},"registerstyle":{"type":"string"},"hide_accordion":{"type":"boolean"},"hide_title":{"type":"boolean"},"expand_all_link":{"type":"boolean"},"load_open":{"type":"boolean"},"color":{"type":"string"},"style":{"type":"string"},"additional_class":{"type":"string"},"lang":{"type":"string"},"sort":{"type":"string"},"order":{"type":"string"},"hstart":{"type":"number","default":2}},"supports":{"html":false},"textdomain":"rrze-glossary","editorScript":"file:./index.js","render":"file:./render.php"}');
